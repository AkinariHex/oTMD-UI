              ...
              >
                <a>
                  <div
                    ...
                    style={{
                      background: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.8)) center center / cover no-repeat, url('${session.cover_url}') center center / cover no-repeat`,
                    }}
                  >
            ...
            <div className="userLogin">
              <button
                style={{
                  ...
                  alignContent: "center",
                  color: "#fff",
                  backgroundColor: "var(--navbar-link-active-background-color)",
                  fill: "#fff",
                  fontWeight: 400,
                }}
                onClick={() => signIn("osu")}
              >
                <img
                  style={{ width: "25px", filter: "contrast(0) brightness(2)" }}
