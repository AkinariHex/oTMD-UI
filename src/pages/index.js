    ...
    <div className="homeContent">
      <div className="appContext">
        ...
        <div className="appButtons">
          ...
          <ExternalLink id="downloadZIP" href={`https://github.com/AkinariHex/oTMD/releases/download/${release[0].tag_name}/otmd_${release[0].tag_name}_x64.zip`}>
            <div className="icon">
          ...
          <ExternalLink id="githubRep" href={'https://github.com/AkinariHex/oTMD'}>
            <div className="icon">
